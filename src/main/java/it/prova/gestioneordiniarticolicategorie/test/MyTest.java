...
public class MyTest {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			testCaricaSommaPrezziDiUnDesinatario(categoriaServiceInstance, articoloServiceInstance, ordineServiceInstance);
	...
	private static void testOrdiniDiUnaCategoria(CategoriaService categoriaServiceIstance,
		...
		Articolo articolo2 = new Articolo("Sapone", "ABZXC098760", 120D, LocalDate.now(), ordine);
	...
	private static void testCaricaOrdinePiuRecenteDiUnaCategoria(CategoriaService categoriaServiceIstance,
		...
		Articolo articolo = new Articolo("Pannolini", "ABZXC098760", 1200D, LocalDate.now(), ordine);
		Articolo articolo2 = new Articolo("Sapone", "ABZXC098760", 120D, LocalDate.now(), ordine2);
	...
	private static void testCaricaSommaPrezziDiUnDesinatario(CategoriaService categoriaServiceIstance,
		...
		Articolo articolo = new Articolo("Pannolini", "ABZXC098760", 1000D, LocalDate.now(), ordine);
		Articolo articolo2 = new Articolo("Sapone", "ABZXC098760", 100D, LocalDate.now(), ordine);
		Articolo articolo3 = new Articolo("Sapone", "ABZXC098760", 12.3D, LocalDate.now(), ordine2);
	...
	private static void testListaDiIndirizziDiordiniAventiArticoliConSeriale(CategoriaService categoriaServiceIstance,
		...
		Articolo articolo = new Articolo("Pannolini", codiceTipo, 1000D, LocalDate.now(), ordine);
		Articolo articolo2 = new Articolo("Sapone", codiceTipo, 100D, LocalDate.now(), ordine);
		Articolo articolo3 = new Articolo("Sapone", codiceTipo, 12.3D, LocalDate.now(), ordine2);
	...
	private static void testOttieniSommaPrezziDiArticoliDiUnaCategoria(CategoriaService categoriaServiceIstance,
		...
		Articolo articolo = new Articolo("Pannolini", "ABZXC098760", 12000D, LocalDate.now(), ordine);
		Articolo articolo2 = new Articolo("Sapone", "ABZXC098760", 120D, LocalDate.now(), ordine);
	...
	private static void testAggiungiArticoloACategoriaEsistente(CategoriaService categoriaServiceIstance,
		...
		Categoria categoriaReload = categoriaServiceIstance.caricaSingoloElementoConArticoli(categoria.getId());
